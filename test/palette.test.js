...
test('service-worker cache was bumped for the restyle', () => {
  ...
  assert.match(sw, /ezone-therapists-v9/);
  assert.ok(!sw.includes('ezone-therapists-v6') && !sw.includes('ezone-therapists-v7') && !sw.includes('ezone-therapists-v8'), 'old cache names must be gone');
});
